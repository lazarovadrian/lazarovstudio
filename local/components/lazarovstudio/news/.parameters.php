...
<?
/** $arCurrentValues["IBLOCK_ID"] - получаем id инфоблока */
...
$arISection=array();
$rsISection = CIBlockSection::GetList(Array("SORT" => "ASC"), Array("IBLOCK_ID" => $arCurrentValues["IBLOCK_ID"]));
while($arr=$rsISection->Fetch()){
	$arISection[$arr["ID"]] = "[".$arr["ID"]."] ".$arr["NAME"];
}
