...
<form class="mt--40" id="<?=$formId?>" action="<?=POST_FORM_ACTION_URI?>" method="POST">
	...
	<?=bitrix_sessid_post()?>
		<div class="col-lg-6 col-md-12 col-12">
			...
			<div class="rnform-group">
				<!-- <?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("PHONE", $arParams["REQUIRED_FIELDS"])):?><?endif?> -->
				<input type="tel" name="user_phone" value="<?=$arResult["AUTHOR_PHONE"]?>" placeholder="<?=GetMessage("MFT_PHONE")?>" require>
			</div>
		...
		<div class="col-lg-6 col-md-12 col-12">
				...
				<textarea name="MESSAGE" placeholder="Вопросы?" require><?=$arResult["MESSAGE"]?></textarea>
			</div>
		</div>
