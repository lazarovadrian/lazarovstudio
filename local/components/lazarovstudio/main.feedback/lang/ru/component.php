...
$MESS ['MF_REQ_PAY'] = "Выберите метод оплаты";
$MESS ['MF_REQ_EMAIL'] = "Укажите E-mail, на который хотите получить ответ.";
$MESS ['MF_REQ_PHONE'] = "Укажите телефон, для связи с менеджером.";
$MESS ['MF_REQ_MESSAGE'] = "Вы не написали сообщение.";
$MESS ['MF_REQ_DOP_INFO'] = "Опитшите дополнительные возможности.";
$MESS ['MF_REQ_TXT_USER'] = "Опишите возможности пользователя вашего сайта.";
