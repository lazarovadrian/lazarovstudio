...
<head>
    ...
    <?php
        ...
        // Подключаем Swiper вместо Slick
        Asset::getInstance()->addJs("//cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.js");
        Asset::getInstance()->addCss("//cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.css");
        
        // Подключаем новый нативный скрипт
        Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/js/hl.js");
        Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/js/main-native.js");
    ?>
    ...
    <style>
        /* Стили для CSS Grid вместо Masonry */
        .masonary-wrapper-activation {
            display: grid;
...
<!-- Скрипты -->
<script src="/local/templates/lazarovstudio/js/bootstrap.bundle.min.js"></script>
<script src="/local/templates/lazarovstudio/js/swiper-bundle.min.js"></script>
<script src="/local/templates/lazarovstudio/js/fancybox.umd.js"></script>
<script src="/local/templates/lazarovstudio/js/wow.min.js"></script>
<script src="/local/templates/lazarovstudio/js/main-native.js"></script>
</body>
</html>