...
?>
	...
	<form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>" class="rn-newsletter mt_md--20 mt_sm--20">
		<?=bitrix_sessid_post()?>
		...
		<div class="form-group">
			<button class="btn-default" id="bx_subscribe_btn_<?=$buttonId?>"><span><?=GetMessage("subscr_form_button")?></span></button>
		</div>
	</form>
	<?
	$frame->beginStub();
