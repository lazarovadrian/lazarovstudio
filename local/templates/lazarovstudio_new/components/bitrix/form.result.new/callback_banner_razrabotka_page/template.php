...
<section class="callback_banner__form container">
	...
	<div class="callback_banner__container">
		...
		<div class="block_desc">
			<p class="title">Консультация по разработке</p>
			<p class="sub_title">FREE</p>
			<p class="desc">Экспресс-консультация. Поможем оценить Ваше ТЗ и дадим рекомендации по разработке на основе стандартных средств Битрикс.</p>
		</div>
	</div>
